...
>
	...
	<g id="hand" opacity="0" scale="0" style="transform-origin: 50% 80%">
		<path
			fill="#FBD1AF"
	...
	<g id="browser" opacity="0" scale="0" style="transform-origin:bottom">
		<g class="Browser" clip-path="url(#a)">
			...
			/>
			<g>
				<circle cx="152" cy="35" r="1.5" fill="#469F8C" />
				<circle cx="159" cy="35" r="1.5" class="fill-secondary" />
				<circle cx="166" cy="35" r="1.5" fill="#B07363" />
			</g>
			<rect
				width="136.83"
				height="2"
	...
	>
		<path
			...
			class="Polygon 1"
		/>
		<path d="m184.828 252.917 3.312 5.003-1.668 1.104-3.312-5.003z" class="Rectangle 1" />
	</g>
	<!-- <g id="stars">
			<g class="yellowstar">
				<path
	...
	<defs>
		<clipPath id="a" class="a">
			<rect width="148" height="106" x="25" y="33" rx="9" transform="rotate(-2.5 25 33.492)" />
		</clipPath>
	</defs>
</svg>
